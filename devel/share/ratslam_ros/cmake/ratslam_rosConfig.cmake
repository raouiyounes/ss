...
if("TRUE" STREQUAL "TRUE")
  set(ratslam_ros_SOURCE_PREFIX /home/younes/git_tt/ratrobot/src/ratslam_ros)
  set(ratslam_ros_DEVEL_PREFIX /home/younes/git_tt/ratrobot/devel)
  ...
  set(ratslam_ros_INSTALL_PREFIX /home/younes/git_tt/ratrobot/install)
...
if(NOT "/home/younes/git_tt/ratrobot/devel/include " STREQUAL " ")
  set(ratslam_ros_INCLUDE_DIRS "")
  set(_include_dirs "/home/younes/git_tt/ratrobot/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ratslam_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/younes/git_tt/ratrobot/src/ratslam_ros/${idir}'.  Ask the maintainer 'David Ball <davidmichaelball@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/younes/git_tt/ratrobot/devel/lib;/opt/ros/kinetic/lib)
